...
def createwidgets():
    root.feedlabel = Label(root, bg="cyan", fg="white", text="WEBCAM FEED", font=('Comic Sans MS',20))
    root.feedlabel.grid(row=1, column=1, padx=10, pady=10, columnspan=2)
    root.cameraLabel = Label(root, bg="cyan", borderwidth=3, relief="groove")
    ...
    root.browseButton = Button(root, width=10, text="BROWSE", command=destBrowse,bg='royal blue',activebackground='purple',activeforeground='yellow')
    root.browseButton.grid(row=3, column=2, padx=10, pady=10)
    root.captureBTN = Button(root, text="CAPTURE", command=Capture, bg="royal blue", font=('Comic Sans MS',15), width=20,activebackground='purple',activeforeground='yellow')
    root.captureBTN.grid(row=4, column=1, padx=10, pady=10)
    root.CAMBTN = Button(root, text="STOP CAMERA", command=StopCAM, bg="royal blue", font=('Comic Sans MS',15), width=13,activebackground='purple',activeforeground='yellow')
    root.CAMBTN.grid(row=4, column=2)
    root.previewlabel = Label(root, bg="cyan", fg="white", text="IMAGE PREVIEW", font=('Comic Sans MS',20))
    root.previewlabel.grid(row=1, column=4, padx=10, pady=10, columnspan=2)
    root.imageLabel = Label(root, bg="Powder Blue", borderwidth=3, relief="groove")
    ...
    root.openImageButton = Button(root, width=10, text="BROWSE", command=imageBrowse,bg='royal blue',activebackground='purple',activeforeground='yellow')
...
def StopCAM():
    ...
    root.CAMBTN.config(text="START CAMERA", command=StartCAM,activebackground='pink',activeforeground='yellow')
    # Displaying text message in the camera label
    root.cameraLabel.config(text="OFF CAM", font=('Comic Sans MS',70),background='olive drab1')
def StartCAM():
    ...
    # Configuring the CAM BIN to display accordingly
